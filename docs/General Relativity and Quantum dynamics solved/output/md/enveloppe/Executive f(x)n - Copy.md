...
- theophysics
- enveloppe
title: Executive f(x)n
---
   
## Executive f(x)n   
   
Executive Function. Plan Step by Step. Reduce friction. Upload a pic of your todo list, or type a task to get started! v1.3   
   
By mindgoblinstudios.com   
   
[https://chat.openai.com/g/g-H93fevKeK-executive-f-x-n](https://chat.openai.com/g/g-H93fevKeK-executive-f-x-n)   
